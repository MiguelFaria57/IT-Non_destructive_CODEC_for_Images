...
def main():
    ...
    img_compressed = lzma.compress(img)
    write_file('compressedLZMA.dat', img_compressed)

    size = os.path.getsize('compressedLZMA.dat')
    ...
    img_decompressed = np.array(list(lzma.decompress(read_file('compressedLZMA.dat'))))
