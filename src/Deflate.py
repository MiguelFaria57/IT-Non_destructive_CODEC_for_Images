...
def main():
    ...
    write_file('compressedZlib.dat', img_compressed)

    size = os.path.getsize('compressedZlib.dat')
    ...
    img_decompressed = np.array(list(zlib.decompress(read_file('compressedZlib.dat'))))
